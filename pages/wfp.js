          ...
          <div className="row">
            <div className="col-lg-7 col-sm-12">
              <div className="">
                ...
                <p className={`${styles.text} me-auto`}>
                  The first one is local to them - <strong>Arud</strong> is a
                  Swiss NGO working in Switzerland and abroad to support and
                  fight addictions of alcohol, drugs, medication, gambling, and
                  the internet, amongst other things. &quot;We offer individual
                  support and treatment for any dependence as well as for
                  hepatitis C – open-minded and unbiased. Professionals from
                  different specialist fields will work with you to improve your
                ...
                <br></br>
                <p className={`${styles.text} me-auto mt-4`}>
                  The second NGO is <strong>Algorithmwatch</strong>, a
                  Germany-based research and advocacy organization that is
                  committed to watching, unpacking and analyzing automated
                  decision-making (ADM) systems and their impact on society.
                  They have released alarming reports about how large tech
                  companies are utilizing their algorithms. Some members of the
                  younger generation have developed lower attention spans,
                  addictive behavior, and mental and physical distress, and many
                  young adults even decide to undertake surgery to alter their
                  physical appearance. The social media we are exposed to is
                  becoming less and less authentic, and what was intended to
                  connect us is now instead setting us apart.{" "}
                  <strong>Algorithmwatch</strong> shed light on the algorithms
                  that are causing such large changes in our societies and
                  behavior.
                  <br />
                  <br />
                  <div className="mt-4"></div> Here&apos;s their website to
